        ...
        >
          <FormWrapper>
            <motion.div drag>
              <Form className="form">
                <FormGroup>
                  <Label for="city">What city do you want to visit next?</Label>
                  <Input
                    type="text"
                    id="city"
                ...
                <FormGroup>
                  <Label for="restaurant">
                    Insert restaurants where you can taste some unusual food
                  </Label>
                  <Input
                    type="text"
                    id="restaurant"
                ...
                <FormGroup>
                  <Label for="activity">
                    Want to get some adrenaline? Insert "must do" activities{" "}
                  </Label>
                  <Input
                    type="text"
                    id="activity"
                ...
                <FormGroup>
                  <Label for="event">
                    Want to attend interesting events, festivals?
                  </Label>
                  <Input
                    type="text"
                    id="event"
                ...
                <FormGroup>
                  <Label for="image">
                    Insert URL of image associated with this city/country
                  </Label>
                  <Input
                    type="text"
                    id="image"
